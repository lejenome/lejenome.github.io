...
class MarkdownPosts
{
	...
	set next(ctxt) { this._next = ctxt; }
	get prev() { return this._prev; }
	set prev(ctxt) { this._prev = ctxt; }
	hasNext() { return this.next.pageId || this.next.postId; }
	hasPrev() { return this.prev.pageId || this.prev.postId; }
}
