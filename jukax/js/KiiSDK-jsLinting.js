...
root.Kii = (function() {
  ...
  */
  ...
  Kii.setLogging = function(logging) {
    ...
    _instance._logging = logging; return _instance._logging;
  };
  ...
  */
  ...
  KiiACLEntry.prototype.setAction = function(value) {
    if (value >= root.KiiACLAction.KiiACLBucketActionCreateObjects && value <= root.KiiACLAction.KiiACLObjectActionWrite) {
      this._action = value; return this._action;
    } else {
  ...
  */
  ...
  KiiACLEntry.prototype.setSubject = function(value) {
    if (value instanceof root.KiiGroup || value instanceof root.KiiUser || value instanceof root.KiiAnyAuthenticatedUser || value instanceof root.KiiAnonymousUser) {
      this._subject = value; return this._subject;
    } else {
  ...
  */
  ...
  KiiACLEntry.prototype.setGrant = function(value) {
    if (value === true || value === false) {
      this._grant = value; return this._grant;
    } else {
  ...
  */
  ...
  KiiGroup.prototype._setOwnerFromContext = function(data) {
    if (root.Kii.getCurrentUser() !== null) {
      ...
      data.owner = this._owner.getUUID(); return data.owner;
    }
  };
...
root.KiiQuery = (function() {
  ...
  */
  ...
  KiiQuery.prototype.setLimit = function(value) {
    if (value > 0) {
      this._limit = value; return this._limit;
    } else {
  ...
  */
  ...
  KiiQuery.prototype.sortByDesc = function(_sortField) {
    ...
    this._sortDescending = true; return this._sortDescending;
  };
  ...
  */
  ...
  KiiQuery.prototype.sortByAsc = function(_sortField) {
    this._sortField = _sortField;
    this._sortDescending = false; return this._sortDescending;
  };
...
root.KiiClause = (function() {
  ...
  KiiClause.constructor = function() {
    ...
    KiiClause._dictExpression = {}; return KiiClause._dictExpression;
  };
...
KiiRequest = (function() {
  ...
  KiiRequest.prototype.addHeader = function(name, value) {
    this._headers[name] = value; return this._headers[name];
  };

  KiiRequest.prototype.setAdminToken = function(token) {
    this._adminToken = token; return this._adminToken;
  };
...
root.KiiUser = (function() {
  ...
  */
  ...
  KiiUser.prototype._setUsername = function(value) {
    ...
    if (KiiUtilities._validateUsername(value)) {
      this._username = $.trim(value); return this._username;
    } else {
  ...
  */
  ...
  KiiUser.prototype.setDisplayName = function(value) {
    ...
    this._displayName = value; return this._displayName;
  };
  ...
  */
  ...
  KiiUser.prototype._setEmailAddress = function(value) {
    ...
    if (KiiUtilities._validateEmail(value)) {
      this._emailAddress = $.trim(value); return this._emailAddress;
    } else {
  ...
  */
  ...
  KiiUser.prototype._setPhoneNumber = function(value) {
    ...
    if (KiiUtilities._validatePhoneNumber(value)) {
      this._phoneNumber = value; return this._phoneNumber;
    } else {
  ...
  KiiUser.prototype._setPassword = function(value) {
    if (KiiUtilities._validatePassword(value)) {
      this._password = value; return this._password;
    } else {
  ...
  */
  ...
  KiiUser.prototype.setCountry = function(value) {
    if (KiiUtilities._validateCountryCode(value)) {
      this._country = value; return this._country;
    } else {
  ...
  */
  ...
  KiiUser.prototype.set = function(key, value) {
    ...
    this._customInfo[key] = value; return this._customInfo[key];
  };
  ...
  */
  ...
  KiiUser.prototype._updateWithJSON = function(json) {
    ...
    if ((this._displayName === null) && (this._username !== null)) {
      this._displayName = this._username; return this._displayName;
    }
  };
  ...
  _KiiSocialConnect.prototype._getManager = function(networkName) {
    if (networkName === root.KiiSocialNetworkName.FACEBOOK) {
      if (this._facebookManager !== null) {
        ...
        this._facebookManager = new root.KiiSCNFacebook(); return this._facebookManager;
      }
    } else if (networkName === root.KiiSocialNetworkName.TWITTER) {
      if (this._twitterManager !== null) {
        return this._twitterManager;
      } else {
        this._twitterManager = new root.KiiSCNTwitter(); return this._twitterManager;
      }
    }
  };
...
root.KiiSocialConnectNetwork = (function() {
  ...
  KiiSocialConnectNetwork.prototype._reset = function() {
    ...
    this._key = null;
    this._secret = null;
    this._extras = null; return this._extras;
  };
  ...
  KiiSocialConnectNetwork.prototype._logOut = function() {
    this._token = null;
    this._tokenExpiration = null;
    this._tokenObject = null; return this._tokenObject;
  };
...
root.InvalidDisplayNameException = function() {
  this.message = "Unable to set displayName. Must be between 4-50 characters."; return this.message;
};

root.InvalidPasswordException = function() {
  this.message = "Unable to set password. Must be between 4-50 characters composed with ascii (exclude control character)"; return this.message;
};

root.InvalidUsernameException = function() {
  this.message = "Unable to set username. Must be between 3 and 64 characters, which can include alphanumeric characters as well as underscores '_' and periods '.'"; return this.message;
};

root.InvalidUserIdentifierException = function() {
  this.message = "User identifier should be one of user name, phone number or email"; return this.message;
};

root.InvalidEmailException = function() {
  this.message = "Unable to set email address. Must be a valid email"; return this.message;
};

root.InvalidPhoneNumberException = function() {
  this.message = "Unable to set phone number. Must begin with a '+' and be at least 10 digits"; return this.message;
};

root.InvalidLocalPhoneNumberException = function() {
  this.message = "Unable to set phone number. Must be a sequence of numbers"; return this.message;
};

root.InvalidCountryException = function() {
  _this.message = "Unable to set country code. Must be 2 alphabetic characters. Ex: US, JP, CN"; return _this.message;
};

root.InvalidURIException = function() {
  _this.message = "Unable to set URI. Must be of the form kiicloud://some/path/to/object/or/entity"; return _this.message;
};

root.InvalidACLAction = function() {
  _this.message = "Unable to set ACL action. Must be one of the permitted values in KiiACLAction"; return _this.message;
};

root.InvalidACLSubject = function() {
  _this.message = "Unable to set ACL subject. Must be of type KiiUser or KiiGroup"; return _this.message;
};

root.InvalidACLGrant = function() {
  _this.message = "Unable to set ACL grant. Must be a boolean type"; return _this.message;
};

root.InvalidLimitException = function() {
  _this.message = "Unable to set query limit. Must be an integer > 0"; return _this.message;
};

root.InvalidArgumentException = function(message) {
  _this.message = 'InvalidArgument: ' + message; return _this.message;
};
...
root.KiiUserAdmin = (function(_super) {
  ...
  KiiUserAdmin.prototype.bucketWithName = function(bucketName) {
    ...
    bucket = new root.KiiBucketAdmin(bucketName, this, this._adminContext._getToken()); return bucket;
  };
